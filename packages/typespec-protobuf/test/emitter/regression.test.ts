...
describe("regression: header escaping (escape: false)", () => {
  it("does NOT backtick-escape @-words when escape is off", () => {
    ...
    const lines = renderProtoComment("Generated by @qninhdt/typespec-protobuf. DO NOT EDIT.", {
      escape: false,
    });
    expect(lines[0]).toBe("// Generated by @qninhdt/typespec-protobuf. DO NOT EDIT.");
  });
